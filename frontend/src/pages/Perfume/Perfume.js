    ...
    render() {
        ...
        return (
            <div className="container mt-5 pb-5">
                <div className="row">
                    ...
                    <div className="col-md-7">
                        ...
                        <table className="table">
                            ...
                            <tr>
                                <td>Nốt hương giữa:</td>
                                <td>{perfume.fragranceMiddleNotes}</td>
                            </tr>
                            <tr>
                                <td>Nốt hương cuối:</td>
                ...
                <div className="mt-5">
                    <h3 className="text-center mb-5">GIỚI THIỆU SẢN PHẨM</h3>
                    {reviews.length === 0 ? <p className="text-center">Chưa có giới thiệu nào cho sản phẩm này.</p> :
                        reviews.map((review) => {
                            return (
                                <div key={review.id}>
                    ...
                    <form onSubmit={this.addReview}>
                        <div className="form-group border mt-5">
                            <div className="mx-3 my-3">
                                <label><span className="text-danger"><b>*</b></span> Tên của bạn</label>
                                <input
                                    type="text"
                                ...
                                <label><span className="text-danger"><b>*</b></span> Bình luận</label>
                                <textarea
                                    rows="4"
                                ...
                                <button type="submit" className="btn btn-dark mt-3">
                                    <FontAwesomeIcon className="mr-2" icon={faPaperPlane}/>Gửi đánh giá
                                </button>
                            </div>
                        </div>
                    </form>
