...
public class MainRestControllerTest {
	...
	public void getAllProducts() throws Exception {
		...
		mockMvc.perform(get("/api/v1/rest")).andExpect(status().isOk()).andExpect(jsonPath("$", hasSize(2)))
	...
	public void getProduct() throws Exception {
		...
		mockMvc.perform(get("/api/v1/rest/1")).andExpect(status().isOk()).andExpect(jsonPath("$.id", equalTo(1)))
