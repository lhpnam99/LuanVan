...
import com.gmail.namb1704836.ecommerce.repository.OrderRepository;
...
/**
 * The service layer class implements the accessor methods of {@link Order}
 * objects in the {@link OrderService} interface database. The class is marked
...
public class OrderServiceImpl implements OrderService {
	/**
	 * Implementation of the {@link OrderRepository} interface for working with
	 * orders with a database.
	 */
	private final OrderRepository orderRepository;

	/**
	 * Implementation of the {@link UserRepository} interface for working with user
	 * with a database.
	 */
	 ...
	 * objects.
	 *
	 * @param orderRepository implementation of the {@link OrderRepository}
	 *                        interface for working with orders with a database.
