...
import com.gmail.namb1704836.ecommerce.service.PerfumeService;

/**
 * The service layer class implements the accessor methods of {@link Perfume}
 * objects in the {@link PerfumeService} interface database. The class is marked
...
public class PerfumeServiceImpl implements PerfumeService {
	/**
	 * Implementation of the {@link PerfumeRepository} interface for working with
	 * perfumes with a database.
	 */
	 ...
	 * objects.
	 *
	 * @param perfumeRepository implementation of the {@link PerfumeRepository}
	 *                          interface for working with perfumes with a database.
	 */
	@Autowired
	...
	/**
	 * Returns list of perfumes which has the same perfume manufacturers, perfume
	 * genders and the price is in the range between of starting price and ending
	...
	/**
	 * Returns list of perfumes which has the same perfume manufacturer with the
	...
	/**
	 * Returns list of perfumes which has the same gender with the value of the
	 * input parameter.
	 *
	...
	public void saveProductInfoById(String perfumeTitle, String perfumer, Integer year, String country,
			String perfumeGender, String fragranceTopNotes, String fragranceMiddleNotes, String fragranceBaseNotes,
			String description, String filename, Integer price, String volume, String type, Long id) {
