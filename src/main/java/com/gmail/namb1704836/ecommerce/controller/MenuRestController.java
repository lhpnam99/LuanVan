...
public class MenuRestController {
	...
	/**
	 * Returns list of perfumes to the menu page by selected parameters. URL request
	...
	public ResponseEntity<?> findProductsByFilterParams(@RequestBody PerfumeSearchFilterDto filterDto) {
		List<Perfume> filter = perfumeService.filter(filterDto.getPerfumers(), filterDto.getGenders(),
				filterDto.getPrices());
	...
	/**
	 * Returns list of perfumes to the menu which has the same perfume gender with
	 * the value of the input parameter. URL request {"/menu/gender"}, method POST.
	 *
	 * @param filterDto data transfer object for filter search.
	 * @return ResponseEntity with HTTP response: status code, headers, and body.
	 */
	...
	/**
	 * Returns list of perfumes to the menu page which has the same perfume
	 * manufacturer with the value of the input parameter. URL request
	 * {"/menu/perfumer"}, method POST.
	 *
	 * @param filterDto data transfer object for filter search.
	 * @return ResponseEntity with HTTP response: status code, headers, and body.
	 */
