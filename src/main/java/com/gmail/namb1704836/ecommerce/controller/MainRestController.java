...
/**
 * Home page controller class. This controller and related pages can be accessed
 * by all users, regardless of their roles. The @RestController it's a
...
public class MainRestController {
	...
	/**
	 * Returns all products to the home page. URL request {"/"}, method GET.
	 *
	...
	/**
	 * Returns product to the home page. URL request {"/product/{id}"}, method GET.
	 *
