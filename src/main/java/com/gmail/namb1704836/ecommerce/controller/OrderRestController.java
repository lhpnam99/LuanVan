...
/**
 * User order controller class. This controller and related pages can be
...
public class OrderRestController {
	...
	/**
	 * Returns the user order. URL request {"/order"}, method GET.
	 *
	...
	/**
	 * Saves the user order. URL request {"/order"}, method POST.
	 *
	 ...
	 */
	@PostMapping("/order")
	public ResponseEntity<?> postOrder(@AuthenticationPrincipal User userSession, @Valid @RequestBody Order validOrder,
	...
	/**
	 * Returns the finalize order with order index. URL request {"/order/finalize"},
	 * method GET.
	 *
	 * @return ResponseEntity with HTTP response: status code, headers, and body.
	 */
	...
	/**
	 * Returns all user orders. URL request {"/order/list"}, method GET.
	 *
	 * @param userSession requested authenticated user.
	 * @return ResponseEntity with HTTP response: status code, headers, and body.
	 */
