...
/**
 * Email configuration class. Marked with @Configuration annotation - the class
 * is the source of the bean definition.
 *
...
public class MailConfiguration {
	...
	/**
	 * SMTP authentication. If true, attempt to authenticate the user using the AUTH
	 * command.
	 */
