...
/**
 * Class for configure JWT. The @Component annotation indicates that this class
 * is a "component". Such classes are considered as candidates for
...
public class JwtConfigurer extends SecurityConfigurerAdapter<DefaultSecurityFilterChain, HttpSecurity> {
	 ...
	 * objects.
	 *
	 * @param jwtFilter authentication filter class to get the JWT token from the
	 *                  request.
	 */
	@Autowired
