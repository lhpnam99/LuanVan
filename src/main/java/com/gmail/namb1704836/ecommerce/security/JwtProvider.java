...
/**
 * Class for generating and verifying JWT. The following utility class will be
 * used for generating a JWT after a user logs in successfully, and validating
 * the JWT sent in the Authorization header of the requests. The @Component
 * annotation indicates that this class is a "component". Such classes are
...
public class JwtProvider {
	 ...
	 *
	 * @param token JWT.
	 * @return true if JWT is not expired and return JwtAuthenticationException if
	 *         JWT expired.
	 */
