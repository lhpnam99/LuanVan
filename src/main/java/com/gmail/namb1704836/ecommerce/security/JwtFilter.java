...
/**
 * Authentication filter class to get the JWT token from the request, validate
 * it, load the user associated with the token, and pass it to Spring Security.
 * The @Component annotation indicates that this class is a "component". Such
...
public class JwtFilter extends GenericFilterBean {
	 ...
	 * the end of the chain. The FilterChain passed in to this method allows the
	 ...
	 * @param filterChain     provides access to the next filter in the chain for
	 *                        this filter to pass the request and response to for
	 *                        further processing.
	 *
