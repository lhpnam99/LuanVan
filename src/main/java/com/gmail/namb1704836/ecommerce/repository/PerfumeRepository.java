...
/**
 * A repository for {@link Perfume} objects providing a set of JPA methods for
...
public interface PerfumeRepository extends JpaRepository<Perfume, Long> {
	/**
	 * Returns list of perfumes from the database which has the same perfume
	 * manufacturers and genders with the value of the input parameter.
	 *
	...
	/**
	 * Returns list of perfumes from the database which has the same perfume
	 * manufacturers or genders with the value of the input parameter.
	 *
	 * @param perfumers perfume manufacturers to return.
	 * @param genders   genders to return.
	 * @return list of {@link Perfume}.
	...
	/**
	 * Returns list of perfumes from the database in which the price is in the range
	...
	/**
	 * Returns list of perfumes from the database which has the same perfume
	 * manufacturer with the value of the input parameter.
	 *
	...
	/**
	 * Returns list of perfumes from the database which has the same gender with the
	...
	/**
	 * Save updated perfume to the database. The @Modifying annotation declaring
